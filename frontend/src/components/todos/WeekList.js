...
class WeekList extends Component {
    ...
    renderWeekWithNoTasks(monday) {
        let res = [];
        res.push(<div className="ui center aligned header"><h3 style={{marginTop: 5}}>Week from {monday}</h3></div>);
    ...
    renderTaskTable(week) {
        ...
        let res = [];
        res.push(<div className="ui center aligned header"><h3 style={{marginTop: 10}}>Week from {week.monday}</h3></div>);
        res.push(
